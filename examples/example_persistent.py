...
@triton.jit
def add_kernel_persistent(threadblock_counter, # for scheduling "virtual/manual/fake" threadblocks on "real" threadblocks
...
def add_persistent(x: torch.Tensor, y: torch.Tensor):
    ...
    add_kernel_persistent[grid](threadblocks_run_atomic, x, y, output, n_elements, BLOCK_SIZE=1024)
    return output
...
if __name__ == "__main__":
    ...
    output_triton_persistent = add_persistent(x, y)
    print(output_torch)
    print(output_triton)
